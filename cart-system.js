/* =========================================================
   ...
   Also injects the mobile menu (hamburger + side drawer)
   so every page gets a clean mobile topbar automatically.
...
(function(window){
  ...
  const MOBILE_STYLES = `
    ...
    .mobile-hamburger:hover { border-color: var(--blue-deep, #5B9DB5); transform: translateY(-1px); }
    .mobile-hamburger svg { width: 20px; height: 20px; color: var(--brown, #554B41); }
    ...
    .sb-drawer-header .sb-drawer-logo img { height: 48px; display: block; }
    .sb-drawer-close { background: white; border: 1.5px solid var(--line, #E8EAED); width: 38px; height: 38px; border-radius: 50%; cursor: pointer; font-size: 16px; color: var(--brown, #554B41); font-family: inherit; transition: border-color 0.3s, transform 0.2s; padding: 0; line-height: 1; }
    .sb-drawer-close:hover { border-color: var(--blue-deep, #5B9DB5); transform: rotate(90deg); }
    .sb-drawer-cta { display: block; background: var(--teal-accent, #4A8FA8); color: white; text-align: center; border-radius: 999px; padding: 14px 18px; font-weight: 500; letter-spacing: 2px; font-size: 13px; text-decoration: none; margin-bottom: 12px; transition: background 0.3s; }
    .sb-drawer-cta:hover { background: var(--brown, #554B41); color: white; }
    .sb-drawer-cta.secondary { background: white; color: var(--teal-accent, #4A8FA8); border: 1.5px solid var(--teal-accent, #4A8FA8); }
    .sb-drawer-cta.secondary:hover { background: var(--teal-accent, #4A8FA8); color: white; }
    .sb-drawer-links { list-style: none; margin: 16px 0 0; padding: 0; flex: 1; }
    .sb-drawer-links li { border-bottom: 1px solid var(--line, #E8EAED); }
    .sb-drawer-links li:last-child { border-bottom: none; }
    .sb-drawer-links a { display: flex; align-items: center; justify-content: space-between; padding: 15px 4px; text-decoration: none; color: var(--brown, #554B41); font-size: 15.5px; font-weight: 500; transition: color 0.2s; }
    .sb-drawer-links a:hover { color: var(--blue-deep, #5B9DB5); }
    .sb-drawer-links a .arrow { color: var(--ink-whisper, #8A8E96); font-size: 14px; }
    .sb-drawer-links a .cart-mini-badge { background: var(--teal-accent, #4A8FA8); color: white; font-size: 11px; font-weight: 700; padding: 2px 8px; border-radius: 999px; margin-inline-start: auto; margin-inline-end: 8px; }
    .sb-drawer-footer { margin-top: 18px; padding-top: 18px; border-top: 1px solid var(--line, #E8EAED); }
    .sb-drawer-social { display: flex; justify-content: center; gap: 14px; }
    .sb-drawer-social a { width: 38px; height: 38px; border-radius: 50%; border: 1px solid var(--line, #E8EAED); background: white; display: flex; align-items: center; justify-content: center; transition: background 0.2s; }
    .sb-drawer-social a:hover { background: #EDF6FA; }
    .sb-drawer-social svg { width: 16px; height: 16px; fill: var(--brown, #554B41); }
  `;
  ...
  const DRAWER_HTML = `
    ...
    <nav class="sb-drawer-panel" aria-label="תפריט ראשי">
      <div class="sb-drawer-header">
        <a href="index.html" class="sb-drawer-logo"><img src="logo-sweetbox.png" alt="Sweet Box"></a>
      ...
      <div class="sb-drawer-footer">
        <div class="sb-drawer-social">
          <a href="https://www.instagram.com/sweetbox.il/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24"><path d="M12 2.2c3.2 0 3.6 0 4.8.1 1.2.1 1.8.2 2.2.4.6.2 1 .5 1.4.9.4.4.7.9.9 1.4.2.4.4 1.1.4 2.2.1 1.3.1 1.6.1 4.8s0 3.6-.1 4.8c-.1 1.2-.2 1.8-.4 2.2-.2.6-.5 1-.9 1.4-.4.4-.9.7-1.4.9-.4.2-1.1.4-2.2.4-1.3.1-1.6.1-4.8.1s-3.6 0-4.8-.1c-1.2-.1-1.8-.2-2.2-.4-.6-.2-1-.5-1.4-.9-.4-.4-.7-.9-.9-1.4-.2-.4-.4-1.1-.4-2.2C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.8c.1-1.2.2-1.8.4-2.2.2-.6.5-1 .9-1.4.4-.4.9-.7 1.4-.9.4-.2 1.1-.4 2.2-.4C8.4 2.2 8.8 2.2 12 2.2zm0 3.4c-3.5 0-6.4 2.9-6.4 6.4s2.9 6.4 6.4 6.4 6.4-2.9 6.4-6.4-2.9-6.4-6.4-6.4zm0 10.6c-2.3 0-4.2-1.9-4.2-4.2s1.9-4.2 4.2-4.2 4.2 1.9 4.2 4.2-1.9 4.2-4.2 4.2zm6.6-10.9c0 .8-.7 1.5-1.5 1.5s-1.5-.7-1.5-1.5.7-1.5 1.5-1.5 1.5.7 1.5 1.5z"/></svg></a>
          <a href="https://www.facebook.com/sweetboxil/" target="_blank" rel="noopener" aria-label="Facebook"><svg viewBox="0 0 24 24"><path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.69.24 2.69.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.26h3.33l-.53 3.49h-2.79V24C19.61 23.1 24 18.1 24 12.07z"/></svg></a>
          <a href="https://www.tiktok.com/@sweetbox_tlv?lang=en" target="_blank" rel="noopener" aria-label="TikTok"><svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.66 20.1a6.34 6.34 0 0 0 10.86-4.43V8.79a8.16 8.16 0 0 0 4.77 1.52V6.86a4.85 4.85 0 0 1-1.71-.17z"/></svg></a>
        </div>
      </div>
    </nav>
  `;

  const HAMBURGER_HTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
